...
- [Deployment](#deployment)
  ...
  - [GitHub Pages](#github-pages)
    ...
    - [Step 3: Deploy the site by running `yarn run deploy`](#step-3-deploy-the-site-by-running-yarn-run-deploy)
...
```sh
yarn add --save husky lint-staged prettier
```
...
```sh
yarn add --save reactstrap bootstrap@4
```
...
1. Run `yarn add --save flow-bin` (or `yarn add flow-bin`).
